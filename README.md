...
* Attention: It hasn't any visual interface. It gives you the treated callback with the informations about the files on some input like its name, size and the original file object.
